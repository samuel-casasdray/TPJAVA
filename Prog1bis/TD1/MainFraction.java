...
class MainFraction { // Classe de test de Fraction et contenant la fonction principale
	...
	f4 = new Fraction(1,2); // fabrication d'une instance de la classe Fraction par recopie de l'instance f2
	...
	System.out.println ("f4 reduite = " + f4.fractionReduite());
	System.out.println ("f4 * f1 = " + f4.multiplier(f1));
	System.out.println ("f4 + f1 = " + f4.addition(f1));
	System.out.println ("f4 / f1 = " + f4.diviser(f1));
	System.out.println ("f4⁵ = " + f4.puissance(5));
