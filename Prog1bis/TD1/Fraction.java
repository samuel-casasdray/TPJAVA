...
public class Fraction {
	...
	*/
    ...
    public void reduire() {
        int a = Ut.pgcd(this.numerateur, this.denominateur);
        this.numerateur /= a;
        this.denominateur /= a;
    }
    ...
    public Fraction multiplier(Fraction f) {
        Fraction fbis = new Fraction(f);
        fbis.numerateur *= this.numerateur;
        fbis.denominateur *= this.denominateur;
        return fbis;
    }

    public Fraction addition(Fraction f) {
        Fraction fbis = new Fraction(f);
        fbis.numerateur = f.numerateur * this.denominateur + this.numerateur * f.denominateur;
        fbis.denominateur = this.denominateur * f.denominateur;
        return fbis;
    }

    public Fraction diviser(Fraction f) {
        return this.multiplier(new Fraction(f.denominateur, f.numerateur));
    }
